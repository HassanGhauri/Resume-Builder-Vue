<!-- src/components/templates/TemplateCreative.vue -->
<template>
  <div class="template-creative" :style="styles">
    <div class="flex flex-col md:flex-row gap-4 md:gap-6" :style="contentStyles">
      ...
      <div class="md:w-2/3 order-2 md:order-1">
        ...
        <div class="mb-4">
          ...
          <p class="text-xs md:text-sm" :style="{ color: textColor }">{{ personal.summary }}</p>
        </div>
      ...
      <!-- Sidebar (Right) -->
      <div class="md:w-1/3 order-1 md:order-2" :style="{ backgroundColor: primaryColor + '10', borderRadius: '8px', padding: '1rem' }">
        <div class="text-center mb-4">
          <div class="w-16 h-16 md:w-20 md:h-20 rounded-full mx-auto flex items-center justify-center text-lg md:text-xl font-bold"
        ...
        <div class="space-y-3">
          <div>
            <h3 class="text-xs font-semibold uppercase" :style="{ color: primaryColor }">Contact</h3>
            <div class="text-xs md:text-sm" :style="{ color: textColor }">
          ...
          <div v-if="hasSkills">
            <h3 class="text-xs font-semibold uppercase" :style="{ color: primaryColor }">Skills</h3>
            <div class="flex flex-wrap gap-1 mt-1">
